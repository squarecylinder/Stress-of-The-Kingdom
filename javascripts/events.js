    ...
    FightEvent: function() {
        ...
        if (getPlayerDexterity >= getEnemyDexterity) {
            ...
            if (enemy.health <= 0) {
                ...
                getArena.innerHTML = '<div<p>After a hard fought battle, you won. You also looted the ' + enemy.enemyType + ' and it had ' + enemy.gold + ' gold!<br>Gained ' + player.xp + ' XP!</p></div>';
                getPlayerGold.innerHTML = 'Gold: ' + player.gold;
                getPlayerHealth.innerHTML = 'Health: ' + player.health;
                ...
                if (player.health <= 0) {
                    ...
                    getArena.innerHTML ='<div><p>After a gruelling battle, you lost. Maybe you should rest before fighting again.<br>Gained ' + player.xp + '!'
