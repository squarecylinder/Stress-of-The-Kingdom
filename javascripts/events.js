...
let EventManager = {
    ...
    FightEvent: function() {
        ...
        if (getPlayerDexterity >= getEnemyDexterity) {
            ...
            getArena.innerHTML = '<div><p>You hit the ' + enemy.enemyType + ' for ' + PlayerAttackValues[0] + ' damage ' + PlayerAttackValues[1] + ' times!</p><p><button class="btn-attack" onclick="EventManager.FightEvent()">Attack!</button></p></div>';
            if (enemy.health <= 0) {
                ...
                getArena.innerHTML = '<div><p>The ' + enemy.enemyType + ' hit you for ' + enemyAttackValues[0] + ' damage ' + enemyAttackValues[1] + ' times!</p><p><button class="btn-attack" onclick="EventManager.FightEvent()">Attack!</button></p></div>';
