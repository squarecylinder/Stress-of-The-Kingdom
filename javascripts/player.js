...
let PlayerManager = {
    ...
    LevelUp : function() {
        ...
        if (player.xp >= 100) {
            ...
            getArena.innerHTML = `<div><p>It looks like you don't have enough xp to level up! Try again later.</p></div>`
        }
    }
}